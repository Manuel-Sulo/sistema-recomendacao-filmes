...
@Component({
  ...
  styles: [`
    ...
    .auth-brand-title {
      ...
      text-shadow: 0 6px 28px rgba(249, 115, 22, 0.35);
    }
    .auth-brand-subtitle {
      font-size: 15px; color: var(--text-muted); margin-top: var(--space-3);
      letter-spacing: 0.08em; text-transform: uppercase; font-weight: 600;
    }
    @media (max-width: 480px) {
      .auth-brand-logo { height: 160px; }
      .auth-brand-title { font-size: 46px; }
    }
